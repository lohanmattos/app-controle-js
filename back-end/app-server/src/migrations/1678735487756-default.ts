...
export class default1678735487756 implements MigrationInterface {
    name = 'default1678735487756'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`FK_9d2bbbf2c04e0bf20e47feae7e7\` ON \`tb_departamento\``);
        await queryRunner.query(`ALTER TABLE \`tb_empresa\` CHANGE \`_id\` \`id\` int NOT NULL AUTO_INCREMENT`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`tb_empresa\` CHANGE \`id\` \`_id\` int NOT NULL AUTO_INCREMENT`);
